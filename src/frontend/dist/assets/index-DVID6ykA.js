const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-Br8JoaIq.js","assets/articles-0z5i4Fz4.js","assets/button-uQgKLJnJ.js","assets/input-C6liU1DS.js","assets/youtube-D6yNwOIk.js","assets/zap-BA7-2Rac.js","assets/News-CbE4gq1f.js","assets/Article-BrnAOs_Q.js","assets/YouTube-B6IySBZH.js","assets/About-Dxn61qrW.js"])))=>i.map(i=>d[i]);
...
function FaceLogo({ size = 40, className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Tamil News Hub logo" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16.5", cy: "16", r: "1.5", fill: "oklch(0.7 0.18 200)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "23.5", cy: "16", r: "1.5", fill: "oklch(0.7 0.18 200)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", "data-ocid": "footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaceLogo, { size: 36 }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-base text-foreground", children: [
            "Tamil",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: " News Hub" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Premier news and analysis for the global Tamil community. Covering politics, technology, culture, and more." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "flex items-center gap-3",
            "data-ocid": "footer.social_links",
            children: socialLinks.map(({ href, icon: Icon2, label, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
                target: "_blank",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm uppercase tracking-widest text-muted-foreground", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm uppercase tracking-widest text-muted-foreground", children: "Stay Informed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Subscribe to our newsletter for daily Tamil news updates." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Tamil News Hub — Serving the global Tamil community" })
    ] })
  ] }) });
}
/**
...
function Header() {
  ...
  const isActive = (href) => href === "/" ? location2.pathname === "/" : location2.pathname.startsWith(href);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
              ...
              children: [
                navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    className: `px-4 py-2 rounded-lg text-sm font-display font-medium transition-smooth ${isActive(link.href) ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                    children: link.label
                  },
                  link.href
                )),
            ...
            children: [
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: `block px-4 py-3 rounded-lg text-sm font-display font-medium transition-smooth ${isActive(link.href) ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                  children: link.label
                },
                link.href
              )),
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-Br8JoaIq.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const NewsPage = reactExports.lazy(() => __vitePreload(() => import("./News-CbE4gq1f.js"), true ? __vite__mapDeps([6,1,3]) : void 0));
const ArticlePage = reactExports.lazy(() => __vitePreload(() => import("./Article-BrnAOs_Q.js"), true ? __vite__mapDeps([7,1,2]) : void 0));
const YouTubePage = reactExports.lazy(() => __vitePreload(() => import("./YouTube-B6IySBZH.js"), true ? __vite__mapDeps([8,4]) : void 0));
const AboutPage = reactExports.lazy(() => __vitePreload(() => import("./About-Dxn61qrW.js"), true ? __vite__mapDeps([9,5]) : void 0));
const queryClient$1 = new QueryClient({
  defaultOptions: { queries: { staleTime: 1e3 * 60 * 5 } }
});
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[60vh] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full border-2 border-primary border-t-transparent animate-spin" }) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient$1, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/news/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ArticlePage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/youtube", element: /* @__PURE__ */ jsxRuntimeExports.jsx(YouTubePage, {}) }),
